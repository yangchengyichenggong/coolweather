...
public class ChooseAreaActivity extends Activity{
					...
					runOnUiThread(new Runnable(){
						...
						public void run(){
							...
							if("province".equals(type)){
								...
								Toast.makeText(ChooseAreaActivity.this, "大象",
	...
	/*
	 * 捕获Back按键，根据级别判断，此时该返回市列表，省列表，还是直接退出
	 * */
